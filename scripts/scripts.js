...
switchModel = document.addEventListener ("click", changeModel);
...
// INSERT YOUR CODE HERE
let switchDuration = document.getElementById("duration-button");
switchDuration = document.addEventListener("click", changeDuration);
